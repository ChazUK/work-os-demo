        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-400">
              Your property management statistics
            </p>
          </div>
          <Link
      ...
      <section>
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-sm text-gray-400">
              Courses tailored to your experience level
            </p>
          </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-white font-semibold mb-1">
                  Landlord Legal Compliance 2024
                </h3>
                <p className="text-sm text-gray-400 mb-3">
                  Stay up-to-date with the latest legal requirements, safety
          ...
          <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-5 hover:border-blue-500/50 transition-colors group cursor-pointer">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-400 mb-3">
                  Master rent collection strategies, handle arrears, and
          ...
          <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-5 hover:border-blue-500/50 transition-colors group cursor-pointer">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-400 mb-3">
                  Learn to manage maintenance requests, find reliable
                  contractors, and prevent costly repairs.
                </p>
                <div className="flex items-center gap-4 text-xs text-gray-500">
                  <span className="flex items-center gap-1">
                    <svg
          ...
          <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-5 hover:border-blue-500/50 transition-colors group cursor-pointer">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-400 mb-3">
                  Build positive tenant relationships and handle disputes
      ...
      <section>
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-sm text-gray-400">
              Exclusive savings at our partner retailers
            </p>
          </div>
          <button className="text-sm text-blue-400 hover:text-blue-300 transition-colors">
            View All Partners →
        ...
        <div className="grid md:grid-cols-3 gap-4">
          ...
          >
            ...
            <p className="text-sm text-gray-400 mb-3">
              Save on tools, building materials, paint, and home improvement
              supplies.
            </p>
          ...
          >
            ...
            <p className="text-sm text-gray-400 mb-3">
              Trade tools, plumbing, electrical supplies, and hardware
              essentials.
            </p>
            <div className="flex items-center text-xs text-gray-500">
              <svg
          ...
          >
            ...
            <p className="text-sm text-gray-400 mb-3">
              Kitchens, bathrooms, building materials, and home improvement
              products.
            </p>
            <div className="flex items-center text-xs text-gray-500">
              <svg
          ...
          >
            <div className="flex items-start justify-between mb-3">
              ...
              <span className="px-2 py-1 bg-yellow-500/10 text-yellow-400 text-xs font-semibold rounded">
                8% OFF
              </span>
            </div>
          ...
          >
            <div className="flex items-start justify-between mb-3">
              ...
              <span className="px-2 py-1 bg-red-500/10 text-red-400 text-xs font-semibold rounded">
                15% OFF
              </span>
            </div>
            <h3 className="text-white font-semibold mb-1">Travis Perkins</h3>
            <p className="text-sm text-gray-400 mb-3">
              Builders merchants with timber, bricks, cement, and construction
              materials.
            </p>
            <div className="flex items-center text-xs text-gray-500">
              <svg
